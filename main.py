...
def add_custom_footer_to_html(html_file_path):
    ...
    try:
        ...
        <div style="
            ...
            line-height: 1.5;
        ">
            <strong>Note:</strong> All metrics in this report are generated using the open-source <a href="https://github.com/Lumiwealth/quantstats_lumi" target="_blank" rel="noopener noreferrer" style="color: #1d4ed8; text-decoration: none; font-weight: 500;">QuantStats-LumiWealth Version</a>. While widely used for performance and risk analytics, some calculations may rely on assumptions (e.g., trading days, compounding methods) or be subject to version-specific behavior. Key metrics such as total return and CAGR have been manually reviewed for consistency, but users are encouraged to refer to the <a href="https://github.com/Lumiwealth/quantstats_lumi" target="_blank" rel="noopener noreferrer" style="color: #1d4ed8; text-decoration: none; font-weight: 500;">official documentation</a> for full methodology.
        </div>
        '''
